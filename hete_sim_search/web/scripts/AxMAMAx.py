...
if __name__ == '__main__':
	...
	actresses_input = str(raw_input('Enter the actresses: '))
	...
	output_file = open("../../sample_outputs/length_5/" +actresses_input+"_output_AxMAMAx.txt", "w")
	...
	for i in range(0,min(top_K,len(sorted_hashmap)),1):
